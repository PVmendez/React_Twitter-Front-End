      ...
      <div className="tweet-form px-3 pt-2 pb-3 d-flex border-bottom">
        ...
        <div className="flex-fill overflow-auto">
          ...
          <div className="form-footer pt-3 d-flex justify-content-between align-items-end">
            <div className="">
              <div class="btn-soft rounded-circle d-inline-flex justify-content-center align-items-center p-2">
              ...
              <div class="btn-soft rounded-circle d-md-inline-flex justify-content-center align-items-center p-2 d-none">
                <svg viewBox="0 0 24 24">
                  <g>
            ...
            <button
              className="py-2 px-3 btn-primary rounded-pill fw-bold fs-7 border-0"
              id="tweet-post"
            >
              Tweet
            </button>
