        ...
        <div className="border-start border-end">
          <main className="border p-0">
            <section className={`container-fluid -0 ${styles.section}`}>
                  ...
                  <p className="">
                    <span className="text-muted fs-7 me-2">
                      <Link to="/user/Chayanne/following">
                        <span className="text-black fw-bold" id="following-count">25 </span>
                        Following
                      </Link>
                    </span>
                    <span className="text-muted fs-7 me-2">
              ...
              { <div id="tweets-section">{user.tweetList.length ? user.tweetList.map((t) => <Tweet key={t._id} tweet={t} />) : <div>No hay tweets{console.log(user)}</div>}</div> }
            </section>
          </main>
        </div>
        <RightSidebar />
